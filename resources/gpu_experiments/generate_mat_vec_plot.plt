...
set title "Execution time of mat-vec multiply on CPU and GPU"
...
newhistogram "GPU", '' u "Memcpy.2":xtic(1) t "Memory Copy" lc rgb "yellow", '' u "Compute.2" t "Compute" lc rgb "blue"
